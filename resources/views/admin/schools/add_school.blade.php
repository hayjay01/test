	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="name" required value="{{ old('name')?old('name'): '' }}">
														@if($errors->has('name'))
					                                    	<span>
					                                    		<strong>
					                                    			{{ $errors->first('name') }}
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="city" required value="{{ old('city')?old('city'): '' }}">
	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="mailing_address" required value="{{ old('mailing_address')?old('mailing_address'): '' }}">
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="phone" required value="{{ old('phone')?old('phone'): '' }}">
														@if($errors->has('phone'))
					                                    	<span>
					                                    		<strong>
					                                    			{{ $errors->first('phone') }}
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="email" class="form-control" name="email" required value="{{ old('email')?old('email'): '' }}">			@if($errors->has('email'))
					                                    	<span>
					                                    		<strong>
					                                    			{{ $errors->first('email') }}
					                                    		</strong>
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="motto" required value="{{ old('motto')?old('motto'): '' }}">
													@if($errors->has('motto'))
					                                    	<span>
					                                    		<strong>
					                                    			{{ $errors->first('motto') }}
	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="mission" required value="{{ old('mission')?old('mission'): '' }}">
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="vision" required value="{{ old('vision')?old('vision'): '' }}">				@if($errors->has('vision'))
					                                    	<span>
					                                    		<strong>
					                                    			{{ $errors->first('vision') }}
					                                    		</strong>
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="why_choose_us" reuired value="{{ old('why_choose_us')?old('why_choose_us'): '' }}">
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="philosophy" requied value="{{ old('philosophy')?old('philosophy'): '' }}">
	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="value" required value="{{ old('value')?old('value'): '' }}">
													@if($errors->has('value'))
					                                    	<span>
					                                    		<strong>
					                                    			{{ $errors->first('value') }}
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="societies" requird value="{{ old('societies')?old('societies'): '' }}">
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="review" required value="{{ old('review')?old('review'): '' }}">					@if($errors->has('review'))
					                                    	<span>
					                                    		<strong>
					                                    			{{ $errors->first('review') }}
					                                    		</strong>
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="aim" required value="{{ old('aim')?old('aim'): '' }}">
													@if($errors->has('aim'))
					                                    	<span>
					                                    		<strong>
					                                    			{{ $errors->first('aim') }}
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control" name="location" require value="{{ old('location')?old('location'): '' }}">
